namespace MvvmDialogs.Main.Examples.Example3.DataBindingWithDataValidation.Model
{
  using System;
  ...
  internal class DataRepository
  {
    ...
    {
      // Dialog only displayed for the purpose of showcasing
      // that data has reached the Model to complete the user action ==> MVVM violation!
